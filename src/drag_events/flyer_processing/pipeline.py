"""Business logic for processing drag racing flyer images into structured event records."""
...
from ..event_validation.cli import validate_events_payload
...
def _build_new_event(extracted: dict, flyer_entry: dict, processed_at: str) -> dict:
    extracted["track"] = backfill_track_from_catalog(build_track_with_id(extracted.get("track") or {}))
